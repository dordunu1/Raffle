...
>(({ className, children, ...props }, ref) => (
  <AccordionPrimitive.Header className="flex bg-transparent">
    <AccordionPrimitive.Trigger
      ref={ref}
      className={cn(
        "flex flex-1 items-center justify-between py-4 text-sm font-medium transition-all hover:no-underline text-left bg-transparent [&[data-state=open]>svg]:rotate-180",
        className,
      )}
      {...props}
    >
